...
def pathLoss(d, lbda):
    return 20*math.log10((4*math.pi*d)/lbda)

def distanciaEntreAntenas(lbda, L0):
    return (lbda/(4*math.pi))*(10**((1/20)*(L0)))
...
def calculaDistancia():
    ...
    lbda = c/f
    L0 = Pt - Pr + Gt + Gr
    d = distanciaEntreAntenas(lbda, L0)
